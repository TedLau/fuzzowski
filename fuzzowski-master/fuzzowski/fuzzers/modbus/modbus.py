...
class MODBUS(IFuzzer):
    ...
    def get_requests() -> List[callable]:
        return [MODBUS.read_coil, MODBUS.read_input, MODBUS.read_holding, MODBUS.read_discrete, MODBUS.single_coil,
                MODBUS.single_register, MODBUS.multiple_coil, MODBUS.multiple_register, MODBUS.other_operations]
    ...
    def define_nodes(*args, **kwargs) -> None:
        ...
        # ---------------------------- Other ---------------------------- #
        # 17 报告从设备ID Report slave ID
        # 22 屏蔽写寄存器 Mask write register
        # 23 读/写寄存器 Read/Write registers
